...
## Project Structure
    ...
    ├── santosh_milestone_a_32384  # Django project configurations
...
1. Clone this repo and `cd santosh_milestone_a_32384`
...
2. Clone this repo and `cd santosh_milestone_a_32384`
